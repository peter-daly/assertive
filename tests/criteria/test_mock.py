...
from assertive.criteria.basic import is_equal_to, is_greater_than, is_less_than
...
def test_mock_matches_passes():
    ...
    assert_that(mock4).matches(
        was_called_once_exactly_with(1, 2, a=3, b=~is_equal_to(5))
    )
